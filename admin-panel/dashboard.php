...
<head>
    ...
    <title>Dashboard | Rwanda Pets Registation Portal</title>
...
$sql = "SELECT COUNT(*) AS total_pets FROM pet_data";
...
?>
                        ...
                        <div class="col-xxl-6 col-md-6">
                            <div class="card info-card sales-card">
                                <div class="card-body">
                                    <h5 class="card-title">Pets <span>| Total</span></h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6><?php echo $total_pets; ?></h6>
                                            <span class="text-success small pt-1 fw-bold"><a href="manage-pets.php">View
                                                    All Pets</a></span>
